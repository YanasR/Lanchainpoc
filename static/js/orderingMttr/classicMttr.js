...
function getData() {
    ...
    $(".loaderSection").show();
    let url = 'http://kicdt19.kcdc.att.com:9004/classic_mttr';
    fetch(url, {
        method: 'GET',
        headers: {
        ...
        if (res.ok) {
            res.json().then(json => {
                ...
                let response = _extractClassicData(json)
...
function getMttrChartId(res) {
    ...
    if (res['serviceLine'] === 'adi') {
        chartId = 'adiMttrBarChartId';
    } else if (res['serviceLine'] === 'avpn') {
        chartId = 'avpnMttrBarChartId';
    } else if (res['serviceLine'] === 'bvoip') {
        chartId = 'bvoipMttrBarChartId';
    } else if (res['serviceLine'] === 'classicall') {
        chartId = 'allMttrBarChartId';
    }
...
function getAvgDaysChartId(res) {
    let chartId;
    if (res['serviceLine'] === 'adi') {
        chartId = 'adiAvgDaysBarChartId';
    } else if (res['serviceLine'] === 'avpn') {
        chartId = 'avpnAvgDaysBarChartId';
    } else if (res['serviceLine'] === 'bvoip') {
        chartId = 'bvoipAvgDaysBarChartId';
    } else if (res['serviceLine'] === 'classicall') {
        chartId = 'allAvgDaysBarChartId';
    }
...
function getTicketChartId(res) {
    let chartId;
    if (res['serviceLine'] === 'adi') {
        chartId = 'adiTicketStatsBarChartId';
    } else if (res['serviceLine'] === 'avpn') {
        chartId = 'avpnTicketStatsBarChartId';
    } else if (res['serviceLine'] === 'bvoip') {
        chartId = 'bvoipTicketStatsBarChartId';
    } else if (res['serviceLine'] === 'classicall') {
        chartId = 'allTicketStatsBarChartId';
    }
