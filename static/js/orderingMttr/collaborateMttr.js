...
function getData() {
    ...
    $(".loaderSection").show();
    let url = 'http://kicdt19.kcdc.att.com:9004/Collab_mttr';
    fetch(url, {
        method: 'GET',
        headers: {
        ...
        if (res.ok) {
            res.json().then(json => {
                ...
                let response = _extractCollabData(json)
...
function _extractCollabData(res) {
    let responseData = [];
...
function getMttrChartId(res) {
    let chartId = 'collabMttrBarChartId';
    return chartId;
}
...
function getAvgDaysChartId(res) {
    let chartId = 'collabAvgDaysBarChartId';
    return chartId;
}
...
function getTicketChartId(res) {
    let chartId = 'collabTicketStatsBarChartId'
    return chartId;
}