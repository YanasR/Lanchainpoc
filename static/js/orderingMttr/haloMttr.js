...
function getData() {
    ...
    $(".loaderSection").show();
    let url = 'http://kicdt19.kcdc.att.com:9004/halo_mttr';
    fetch(url, {
        method: 'GET',
        headers: {
        ...
        if (res.ok) {
            res.json().then(json => {
                ...
                let response = _extractHaloData(json)
...
function _extractHaloData(res) {
    let responseData = [];
    responseData.push(res['adi']);
    responseData.push(res['all']);
    responseData.push(res['avpn']);
    responseData.push(res['ipflex']);
    return responseData;
}
...
function getMttrChartId(res) {
    let chartId;
    if (res['serviceLine'] === 'adi') {
        chartId = 'adiHaloMttrBarChartId';
    } else if (res['serviceLine'] === 'avpn') {
        chartId = 'avpnHaloMttrBarChartId';
    } else if (res['serviceLine'] === 'ipflex') {
        chartId = 'ipflexHaloMttrBarChartId';
    } else if (res['serviceLine'] === 'haloall') {
        chartId = 'allHaloMttrBarChartId';
    }
...
function getAvgDaysChartId(res) {
    let chartId;
    if (res['serviceLine'] === 'adi') {
        chartId = 'adiHaloAvgDaysBarChartId';
    } else if (res['serviceLine'] === 'avpn') {
        chartId = 'avpnHaloAvgDaysBarChartId';
    } else if (res['serviceLine'] === 'ipflex') {
        chartId = 'ipflexHaloAvgDaysBarChartId';
    } else if (res['serviceLine'] === 'haloall') {
        chartId = 'allHaloAvgDaysBarChartId';
    }
...
function getTicketChartId(res) {
    let chartId;
    if (res['serviceLine'] === 'adi') {
        chartId = 'adiHaloTicketStatsBarChartId';
    } else if (res['serviceLine'] === 'avpn') {
        chartId = 'avpnHaloTicketStatsBarChartId';
    } else if (res['serviceLine'] === 'ipflex') {
        chartId = 'ipflexHaloTicketStatsBarChartId';
    } else if (res['serviceLine'] === 'haloall') {
        chartId = 'allHaloTicketStatsBarChartId';
    }
