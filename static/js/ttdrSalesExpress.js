const footer = ` </table>`;
const URL = `http://kicdt19.kcdc.att.com:9007/`;
...
function generateReport() {
    const adiUrl = URL + 'se/ADIEXP';
    const abfUrl = URL + 'se/ABFEXP';
    const sdwanUrl = URL + 'se/SDWAN';
    const oahUrl = URL + 'se/OAH';
    const adiVbUrl = URL + 'se/ADIVB';
    const totalUrl = URL + 'se/total';
    initResponseObj();
